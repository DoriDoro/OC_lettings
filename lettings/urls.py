...
URL Patterns:
    - ``/lettings/`` - URL for the lettings index page, displaying a list of :class:`lettings.Letting` properties.
    - ``/lettings/<int:letting_id>/`` - URL pattern for viewing details of a specific :class:`lettings.Letting`
