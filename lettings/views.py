...
This module defines views for handling HTTP requests related to :class:`lettings.Letting` properties
in the lettings app of the project.

Views:
    index: Renders the lettings index page, displaying a list of all :class:`lettings.Letting` properties.
    letting: Renders the details page for a specific :class:`lettings.Letting` property identified by its ID.
...
Usage:
    ...
    their titles and addresses. They interact with the Letting model retrieve data
...
:param get_object_or_404: A function provided by Django that retrieves an object from the database or raises a Http404
